...
export default {
    ...
    edit: {
        w: "0 0 20 20",
        s: {fill: COLOR.BORDER},
        d: `M18.303,4.742l-1.454-1.455c-0.171-0.171-0.475-0.171-0.646,0l-3.061,
        ...
        0.267l0.267-1.076l6.097-6.091l0.808,0.808L11.241,11.156z`
    },

    save: {
        w: "0 0 20 20",
        s: {fill: COLOR.BORDER},
        d: `M17.064,4.656l-2.05-2.035C14.936,2.544,14.831,2.5,14.721,
        ...
        0.188-0.417,0.417-0.417C13.217,4.271,13.402,4.458,13.402,4.688`
    },

    exec: {
        w: "0 0 20 20",
        s: {fill: COLOR.BORDER},
        d: `M12.319,5.792L8.836,2.328C8.589,2.08,8.269,2.295,8.269,
        ...
        1.659,1.022,2.66C16.226,13.451,14.428,15.238,12.217,15.238`
    },

    add: {
        w: "0 0 20 20",
        s: {fill: COLOR.BORDER},
        d: `M14.613,10c0,0.23-0.188,0.419-0.419,0.419H10.42v3.774c0,0.23-0.189,
        ...
        2.87,10c0,3.933,3.198,7.13,7.13,7.13S17.13,13.933,17.13,10`
    },

    nail: {
        w: "0 0 20 20",
        s: {fill: COLOR.BORDER},
        d: `M17.592,8.936l-6.531-6.534c-0.593-0.631-0.751-0.245-0.751,
        ...
        8.845l-3.177-3.177V3.762l5.083,5.083H14.335z`
    },

    delete: {
        w: "0 0 20 20",
        s: {fill: COLOR.BORDER},
        d: `M14.776,10c0,0.239-0.195,0.434-0.435,0.434H5.658c-0.239,
        ...
        2.619,10c0,4.07,3.311,7.382,7.381,7.382C14.07,17.383,17.382,14.07,17.382,10`
    },
    ...
    up: {
        ...
        d: `M 9.9787966,7.023306 4.0677781,12.976694 M 15.932186,
        12.934323 9.9787976,7.023305`
    },
    ...
    down: {
        ...
        d: `M 15.932186,7.0656768 9.9787976,12.976695 m -10e-7,
        -10e-7 -5.9110185,-5.953388`
    },
    ...
    checked: {
        ...
        d: `M 9.9787966,12.976694 4.0677781,7.023306 M 15.932186,7.0656768
        9.9787976,12.976695 M 1.7154646,2.2697649 H 18.284535 V 17.730235
        H 1.7154646 Z`
    },
    ...
    unchecked: {
        ...
        d: `M 1.7154646,2.2697649 H 18.284535 V 17.730235 H 1.7154646 Z`
    }
